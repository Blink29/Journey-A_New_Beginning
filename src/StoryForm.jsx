...
const StoryForm = ({ onSubmit, onStoryGenerated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        // Pass the story data, scene descriptions, and media results to the parent component
        if (onStoryGenerated) {
          onStoryGenerated(data.story, data.scene_descriptions, data.media_results || []);
        }
        
        console.log(data.story);
        console.log("Scene descriptions:", data.scene_descriptions);
        if (data.media_results) {
          console.log("Media results:", data.media_results);
        }
      } else {
